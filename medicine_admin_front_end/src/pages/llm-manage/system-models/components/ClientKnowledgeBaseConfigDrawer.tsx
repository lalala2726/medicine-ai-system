...
interface ClientKnowledgeBaseConfigDrawerProps {
  open: boolean;
  detail?: SystemModelTypes.ClientKnowledgeBaseSystemModelConfig;
  onClose: () => void;
...
const ClientKnowledgeBaseConfigDrawer: React.FC<ClientKnowledgeBaseConfigDrawerProps> = ({
  open,
  detail,
  onClose,
  onSaved,
  ...
  const handleSave = useCallback(async () => {
    try {
      ...
      setSaving(true);
      await saveClientKnowledgeBaseConfig({
      ...
      message.error(getErrorMessage(error, '客户端知识库配置保存失败'));
    } finally {
      setSaving(false);
    }
          ...
          <div className={styles.drawerBody}>
            <Card className={styles.slotCard} size="small">
              <div className={styles.slotHeader}>
                <div>
                  <div className={styles.slotTitle}>客户端知识库访问与检索配置</div>
              ...
              <Form.Item
                ...
                extra="关闭后，客户端聊天节点将不再访问知识库进行检索"
                className={styles.compactFormItem}
              >
                <Switch data-testid="client-knowledge-base-enabled-switch" />
              </Form.Item>
              ...
              >
                <Select
                  ...
                  data-testid="client-knowledge-base-name-select"
                />
              </Form.Item>
              ...
              >
                <Switch disabled={!knowledgeBaseEnabled} />
              </Form.Item>
...
export default ClientKnowledgeBaseConfigDrawer;
